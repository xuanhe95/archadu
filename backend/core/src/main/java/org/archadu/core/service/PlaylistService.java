...
public class PlaylistService {
    ...
    public Playlist createPlaylist(Long userId, String playlistName, String description, boolean isPublic, boolean isCollaborative) {
        User user = userRepo.findById(userId).orElseThrow(() -> new RuntimeException("User not found"));
        Playlist playlist = new Playlist(user, playlistName, description, isPublic, isCollaborative);
        playlistsRepo.save(playlist);
        return playlist;
    }

    public Playlist updatePlaylist(String playlistId, String playlistName, String description, Boolean isPublic, Boolean isCollaborative) {
